...
function MobileNavigation({ OpenMobileNavModal, openMobile }) {
  const closeMobileNavHandler = () => {
    OpenMobileNavModal(false);
  };

  return (
    <div
      className={`fixed top-0 right-0 h-full w-64 bg-white shadow-lg z-40 transition-transform transform ${
